      ...
      <div className="page-container">
        <div className="form-container">
          ...
          <p className="form-description">
            Enter the ID for a person to retrieve their information from the
            database. Leave the form empty to get information about a random
            person.
          </p>
          <PageForm
        ...
        <div className="results-container">
          <h2 className="results-title">{`Results for Person ID: ${
            this.state.result ? this.state.personId : ""
          }`}</h2>
